...
```
cd existing_repo
git remote add origin http://gitlab.starlinewindows.com/it-development/revitautodimension.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab.starlinewindows.com/it-development/revitautodimension/-/settings/integrations)
